...
public class GameFrame extends JFrame {
    ...
    public class BoardPanel extends JPanel {
        ...
        Font fnt1 = new Font("Impact", 2 / 2, 330 / 2);
        Font fnt2 = new Font("Impact", 2 / 2, 70 / 2);
        ...
        public void paintComponent(Graphics g) {
            ...
            if (turnLimit != 0) {
                ...
                g.setFont(fnt2);
                g.drawString("Turn Limit " + turnLimit, 0, 110 / 2);
            }

            // Player2(White) information
            g.setColor(Color.white);
            g.fillRect(910, 0, 850 / 2, 450 / 2);
            g.setColor(Color.black);
            g.setFont(fnt1);
            g.drawString("" + getScore(MarbleType.BLACK), 995, 310 / 2);
            g.setFont(fnt2);
            g.drawString("White", 1090, 110 / 2);
            ...
            g.setColor(Color.black);
            g.fillRect(910, 400 / 2, 850 / 2, 450 / 2);
            g.setColor(Color.white);
            g.setFont(fnt1);
            g.drawString("" + getScore(MarbleType.WHITE), 995, 750 / 2);
            g.setFont(fnt2);
            g.drawString("Black", 1090, 550 / 2);
